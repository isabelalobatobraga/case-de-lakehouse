...
SELECT
    ...
    -- Identifies the account code format (future-proof)
    'BR_BANKING' AS account_code_type,

    -- Unified masked account code (Brazil format)
    CONCAT(
        account_branch_masked, '-',
        account_number_masked, '-',
        account_check_digit_masked
    ) AS account_code,
